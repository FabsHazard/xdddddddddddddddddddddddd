...
export const Features1 = () => {
  return (
    <section
      ...
      style={{
        //backgroundImage: "linear-gradient(to bottom, #140836 10%, #26272b)", // Define your gradient colors here
        backgroundImage:   `url(${background1})`,        
        backgroundSize: 'cover', // Set the background size to cover the section
